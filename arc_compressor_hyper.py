...
class ARCCompressorHyper:
    ...
    with a HyperNetworkARC, which generates all weights dynamically based on
    a learned puzzle embedding and task metadata.
    ...
    def __init__(self, task: Task, hypernetwork: HyperNetworkARC, puzzle_emb: torch.Tensor):
        """
        ...
        Args:
            ...
            puzzle_emb: Learnable puzzle embedding for this task [emb_dim]
        """
        self.task = task
        self.multitensor_system = task.multitensor_system
        self.hypernetwork = hypernetwork
        self.puzzle_emb = puzzle_emb

        # Generate all weights using hypernetwork
        self.weights_list = hypernetwork.forward(task, puzzle_emb)

        # Unpack weights into named components
        # Note: This unpacking must match the order in hypernetwork_arc.py
